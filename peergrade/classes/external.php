...
class core_peergrade_external extends external_api {
    ...
    /**
     * Returns description of add_peergrade parameters.
     *
     * @return external_function_parameters
     * @since Moodle 3.2
     */
    public static function add_peergrade_parameters() {
        return new external_function_parameters (
                array(
                        'contextlevel' => new external_value(PARAM_ALPHA, 'context level: course, module, user, etc...'),
                        'instanceid' => new external_value(PARAM_INT, 'the instance id of item associated with the context level'),
    ...
    public static function add_peergrade($contextlevel, $instanceid, $component, $peergradearea, $itemid, $peergradescaleid, $peergrade,
        ...
        // Validate and normalize parameters.
        $params = self::validate_parameters(self::add_peergrade_parameters(), $params);
    ...
    /**
     * Returns description of add_peergrade result values.
     *
     * @return external_single_structure
     * @since Moodle 3.2
     */
    public static function add_peergrade_returns() {

        return new external_single_structure(
                array(
                        'success' => new external_value(PARAM_BOOL, 'Whether the peergrade was successfully created'),
                        'aggregate' => new external_value(PARAM_TEXT, 'New aggregate', VALUE_OPTIONAL),
                        'count' => new external_value(PARAM_INT, 'PeerGrades count', VALUE_OPTIONAL),
                        'itemid' => new external_value(PARAM_INT, 'PeerGrade item id', VALUE_OPTIONAL),
                        'warnings' => new external_warnings(),
                )
        );
    }
