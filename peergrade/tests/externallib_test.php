...
class core_peergrade_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function test_get_item_peergrades() {
        ...
        try {
            $peergrades =
                    core_peergrade_external::get_item_peergrades('module', $forum->cmid, 'mod_forum', 'xyz', $post->id, 100, '');
        ...
        try {
            $peergrades =
                    core_peergrade_external::get_item_peergrades('module', $forum->cmid, 'mod_forum', 'post', $post->id, 100, '');
