...
class core_peergrade_testcase extends advanced_testcase {
    ...
    public function test_get_aggregate_string($method, $aggregate, $isnumeric, $scaleitems, $expectation) {
        ...
        $peergrade = new peergrade($options);
        $this->assertEquals($expectation, $peergrade->get_aggregate_string());
    }
}
