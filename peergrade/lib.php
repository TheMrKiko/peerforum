...
class peergrade_manager {
     ...
     *         [required] peergradescaleid          => int the scale from which the user can select a peergrade [required] userid
     *                 => int the id of the current user [optional] returnurl        => string the url to return the user to after
     *         submitting a peergrade. Null for ajax requests [optional] assesstimestart  => int only allow peergrade of items
     *         created after this timestamp [optional] assesstimefinish => int only allow peergrade of items created before this
     *         timestamp [optional]
        ...
        foreach ($options->items as $item) {
            ...
            foreach ($userpeergrades as $userpeergrade) {
                ...
                if ($item->{$itemidcol} == $userpeergrade->itemid) {
                    ...
                    $peergradeoptions->peergrade =
                            min($userpeergrade->userspeergrade, $peergradeoptions->settings->peergradescale->max);
     ...
     *      aggregate         => int Aggregation method to apply. PEERGRADE_AGGREGATE_AVERAGE, PEERGRADE_AGGREGATE_MAXIMUM etc
     *         [required] peergradescaleid           => int the peergradescale from which the user can select a peergrade
     *         [required] returnurl         => string the url to return the user to after submitting a peergrade. Null for ajax
     *         requests [optional] assesstimestart   => int only allow peergrade of items created after this timestamp [optional]
     *         assesstimefinish  => int only allow peergrade of items created before this timestamp [optional] plugintype        =>
     *         string plugin type ie 'mod' Used to find the permissions callback [optional] pluginname        => string plugin name
     *         ie 'forum' Used to find the permissions callback [optional]
     * }
     ...
     *
     * @param stdClass $options {
     *      userid => int the id of the user whose items were ratedpeer, NOT the user who submitted peergrades. 0 to update all.
     *         [required] aggregationmethod => int the aggregation method to apply when calculating grades ie
     *         PEERGRADE_AGGREGATE_AVERAGE [required] peergradescaleid => int the peergradescale from which the user can select a
     *         peergrade. Used for bounds checking. [required] itemtable => int the table containing the items [required]
     *         itemtableusercolum => int the column of the user table containing the item owner's user id [required] component =>
     *         The component for the peergrades [required] peergradearea => The peergradearea for the peergrades [required]
     *         contextid => int the context in which the ratedpeer items exist [optional] modulename => string the name of the
     *         module [optional] moduleid => int the id of the module instance [optional]
     * }
     ...
     *      peergradescaleid => int the peergradescale from which the user can select a peergrade. Used for bounds checking.
     *         [required] peergrade => int the submitted peergrade ratedpeeruserid => int the id of the user whose items have been
     *         ratedpeer. 0 to update all. [required] aggregation => int the aggregation method to apply when calculating grades ie
     *         PEERGRADE_AGGREGATE_AVERAGE [optional]
