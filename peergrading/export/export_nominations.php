...
header('Content-Disposition: attachment; filename="peer_nominations.csv"');
//do not cache the file
header('Pragma: no-cache');
header('Expires: 0');

$file = fopen('php://output', 'w');
fputcsv($file, array('StudentID', 'Student', 'Favorite Peer 1', 'Favorite Peer 2', 'Favorite Peer 3', 'Favorite Peer 4'));

// Open the connection
$link = mysqli_connect($CFG->dbhost, $CFG->dbuser, $CFG->dbpass, $CFG->dbname);

//query the database
$query = "SELECT r.iduser, u.firstname, u.lastname, r.peersfav
