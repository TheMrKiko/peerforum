...
$string['viewpeergrades'] = 'View Peergrades';
$string['managegraders_poststopeergrade'] = 'Manage Graders with' . "<br>" . 'posts not peergraded';
$string['managegraders_postspeergraded'] = 'Manage Graders with' . "<br>" . 'posts peergraded';
...
$string['viewgradersstats'] = 'View graders statistics';
