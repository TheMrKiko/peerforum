...
/**
 * Strings for component 'block_peerblock', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    block
...
$string['pgincourse'] = 'Peer grading in {$a->coursename}';
$string['pgbyuserincourse'] = 'Peer grading by {$a->fullname} in {$a->coursename}';
$string['poststopeergrade'] = 'Posts to Peer Grade';
$string['postsexpired'] = 'Posts Expired';
$string['postspeergraded'] = 'Posts Peer Graded';
$string['viewpeergrades'] = 'Peer Grades';
$string['managegraders_posts'] = "Graders posts";
$string['manageposts'] = 'Posts';
...
$string['enablepeergrade_help'] = 'Set to \'no\' if you do not want to enable peer grade on PeerForum';
...
$string['seeoutliers_help'] =
        'Set to \'no\' if you do not want to see the outliers displayed in red in the section View Peergrades of the Peer Grade panel';
$string['outlierdetection'] = 'Outliers detection';
$string['outlierdetection_help'] = 'Select which method should be used to detect outliers';
$string['outdetectvalue'] = 'Outliers method value';
$string['outdetectvalue_help'] = 'Select an integer value which would be used in the outliers detection method';
...
$string['warningoutliers_help'] =
        'Configure the threshold value for warnign outliers (yellow grades on the Peer Grade panel on View Peergrades tab)';
$string['viewpanel'] = 'Go to Peer Grade panel ...';
$string['invalidcourse'] = 'The courseid $a does not exist';
$string['labelallowhtml'] = 'Allow global label';
$string['headerconfig'] = 'Global configurations';
$string['descconfig'] = 'Label configurations';
$string['descallowhtml'] = 'Allow changing the block label title';
$string['studentsperpost'] = 'Students assigned to discssion topic';
$string['threadingstats'] = 'Threaded Grading';
$string['rankinghelp'] =
        'Classify your peer(s) from 1 (dislike a lot) to 5 (like a lot). If you do not know someone, classify with 0.';
$string['classifyranking'] = 'Ranking';
$string['peer_ranking'] = "Peers To Rank";
$string['add'] = "Add";
