...
$string['writefeedback'] = 'Write your feedback...';
...
$string['peerforum:viewanypeergrade'] = 'View the aggregated peer grades that anyone received';
$string['peerforum:viewpeergrade'] = 'View the aggregated peer grades you received';
$string['peerforum:viewsomepeergrades'] = "View all raw peer grades you received";
...
$string['areatraining'] = 'Training pages (old)';
$string['areatrainingpage'] = 'Training pages';
$string['areatrainingexercise'] = 'Training exercises';
