...
/**
 * Class mod_peerforum_portfolio_caller_testcase
 *
 * Tests behaviour of the peerforum_portfolio_caller class.
 */
class mod_peerforum_portfolio_caller_testcase extends advanced_testcase {
    ...
    public function test_file_in_user_post_is_loaded() {
        ...
        /* @var mod_peerforum_generator $peerforumgenerator */
        $peerforumgenerator = $this->getDataGenerator()->get_plugin_generator('mod_peerforum');
        $discussion = $peerforumgenerator->create_discussion(
                array(
                        'course' => $course->id,
        ...
        $caller = new peerforum_portfolio_caller(array(
    ...
    public function test_file_not_in_user_post_not_loaded() {
        ...
        $secondpost = $peerforumgenerator->create_post(
                array(
