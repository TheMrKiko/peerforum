 ...
 * @copyright  2019 Ryan Wyllie <ryan@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \mod_peerforum\local\vaults\post
 */
class mod_peerforum_vaults_post_testcase extends advanced_testcase {
    // Make use of the test generator trait.
    use mod_peerforum_tests_generator_trait;

    /** @var \mod_peerforum\local\vaults\post */
    private $vault;
    ...
    public function test_get_from_discussion_id() {
        ...
        $course = $datagenerator->create_course();
        $peerforum = $datagenerator->create_module('peerforum', ['course' => $course->id]);
        [$discussion1, $post1] = $this->helper_post_to_peerforum($peerforum, $user);
        $post2 = $this->helper_reply_to_post($post1, $user);
        $post3 = $this->helper_reply_to_post($post1, $user);
        [$discussion2, $post4] = $this->helper_post_to_peerforum($peerforum, $user);
    ...
    public function test_get_from_discussion_id_private_replies() {
        ...
        [$discussion, $post] = $this->helper_post_to_peerforum($peerforum, $teacher);
    ...
    public function test_get_from_discussion_ids_private_replies() {
        ...
        [$otherdiscussion, $otherpost] = $this->helper_post_to_peerforum($peerforum, $teacher);
    ...
    public function test_get_replies_to_post() {
        ...
        $datagenerator = $this->getDataGenerator();
        $peerforumgenerator = $datagenerator->get_plugin_generator('mod_peerforum');
        $user = $datagenerator->create_user();
        $course = $datagenerator->create_course();
        $peerforum = $datagenerator->create_module('peerforum', ['course' => $course->id]);
        [$discussion1, $post1] = $this->helper_post_to_peerforum($peerforum, $user);
        ...
        $post2 = $peerforumgenerator->create_post((object) [
        ...
        [$discussion2, $post5] = $this->helper_post_to_peerforum($peerforum, $user);
    ...
    public function test_get_replies_to_post_private_replies() {
        ...
        [$discussion, $p] = $this->helper_post_to_peerforum($peerforum, $student);
    ...
    public function test_get_reply_count_for_discussion_ids() {
        ...
        [$discussion3, $post7] = $this->helper_post_to_peerforum($peerforum, $user);
    ...
    public function test_get_unread_count_for_discussion_ids() {
        ...
        $modgenerator = $this->getDataGenerator()->get_plugin_generator('mod_peerforum');
        ...
        peerforum_tp_add_read_record($user->id, $post1->id);
        peerforum_tp_add_read_record($user->id, $post4->id);
        $CFG->peerforum_oldpostdays = 1;
    ...
    public function test_get_latest_posts_for_discussion_ids() {
        ...
        $post6 = $this->helper_reply_to_post($post5, $user);
        [$discussion3, $post7] = $this->helper_post_to_peerforum($peerforum, $user);
        $post8 = $this->helper_post_to_discussion($peerforum, $discussion3, $teacher, [
    ...
    public function test_get_from_filters_empty() {
        ...
        $peerforum = $datagenerator->create_module('peerforum', ['course' => $course->id]);
        $this->helper_post_to_peerforum($peerforum, $student1);
