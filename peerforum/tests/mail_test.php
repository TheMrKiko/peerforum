...
class mod_peerforum_mail_testcase extends advanced_testcase {
    ...
    use mod_peerforum_tests_cron_trait;
    ...
    /**
     * Ensure that for a peerforum with subscription disabled that standard users will not receive posts.
     */
    ...
    /**
     * Ensure that for a peerforum with subscription disabled that a user subscribed to the peerforum will receive the post.
     */
    public function test_subscription_disabled_user_subscribed_peerforum() {
        global $DB;
    ...
    /**
     * Ensure that for a peerforum with subscription disabled that a user subscribed to the discussion will receive the
     * post.
     */
    ...
    /**
     * Ensure that for a peerforum with automatic subscription that users receive posts.
     */
    ...
    public function test_automatic_with_private_reply() {
        ...
        $reply = $this->helper_post_to_discussion($peerforum, $discussion, $teacher, [
    ...
    public function test_subscription_by_inactive_users() {
        ...
        // Subscribe the three users to the peerforum.
        \mod_peerforum\subscriptions::subscribe_user($u1->id, $peerforum);
        \mod_peerforum\subscriptions::subscribe_user($u2->id, $peerforum);
        \mod_peerforum\subscriptions::subscribe_user($u3->id, $peerforum);
    ...
    public function test_long_subject() {
        ...
        // Post a discussion to the peerforum.
        $subject =
                'This is the very long peerforum post subject that somebody was very kind of leaving, it is intended to check if long subject comes in mail correctly. Thank you.';
    ...
    public function test_subjects() {
        ...
        $reply = $this->helper_post_to_discussion($peerforum, $discussion, $commenter);
                ...
                'expectations' => array(
                        array(
                                ...
                                'contents' => array(
                                        ...
                                        'https://www.example.com/moodle/pluginfile.php/\d*/mod_peerforum/attachment/\d*/example.txt' .
                                        PHP_EOL,
    ...
    public function test_already_mailed() {
        ...
        // Post a discussion to the peerforum.
        list($discussion, $post) = $this->helper_post_to_peerforum($peerforum, $author);
        $DB->set_field('peerforum_posts', 'mailed', 1);
    ...
    public function test_mailnow() {
        ...
        // Post a discussion to the peerforum.
        list($discussion, $postmailednow) = $this->helper_post_to_peerforum($peerforum, $author, ['mailnow' => 1]);
    ...
    public function test_access_coursemodule_hidden() {
        ...
        set_coursemodule_visible($peerforum->cmid, 0);
    ...
    public function test_access_before_timestart() {
        ...
        $DB->set_field('peerforum_discussions', 'timestart', time() + DAYSECS);
    ...
    public function test_access_after_timeend() {
        ...
        // Update the discussion to have a timestart in the past.
        $DB->set_field('peerforum_discussions', 'timeend', time() - DAYSECS);
    ...
    public function test_notification_customdata() {
        ...
        $this->assertEquals($peerforum->id, $customdata->instance);
        $this->assertEquals($peerforum->cmid, $customdata->cmid);
