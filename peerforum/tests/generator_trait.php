...
/**
 * The peerforum module trait with additional generator helpers.
 *
...
trait mod_peerforum_tests_generator_trait {
     ...
     */
    protected function helper_post_to_discussion($peerforum, $discussion, $author, array $options = []) {
        global $DB;
