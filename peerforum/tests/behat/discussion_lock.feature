...
Feature: As a teacher, you can manually lock individual discussions when viewing the discussion
  ...
  Scenario: Lock a discussion and view
    ...
    And I navigate to post "Discussion 1" in "Test peerforum name" peerforum
  ...
  Scenario: A locked discussion must be accessible
    ...
    And I am on "Course 1" course homepage
    And I navigate to post "Discussion 1" in "Test peerforum name" peerforum
    When I reply "Discussion 1" post from "Test peerforum name" peerforum with:
    ...
    And I click on "PeerForum preferences" "link"
