...
Feature: Students can choose from 4 discussion display options and their choice is remembered
  ...
  Scenario: Display replies in threaded form
    ...
    And I should see "Reply 1 to discussion 1" in the "div.peerforumthread" "css_element"
    ...
    And I should see "Reply 1 to discussion 2" in the "div.peerforumthread" "css_element"
