...
Feature: Posting to groups in a separate group discussion when restricted to groupings
  In order to post to groups in a peerforum with separate groups and groupings
  As a teacher
  ...
  Scenario: Teacher with accessallgroups can post in all groups
    ...
    And I follow "Course 1"
    And I follow "Multiple groups peerforum"
    ...
    And I follow "Course 1"
    And I follow "Single groups peerforum"
