@mod @mod_peerforum
Feature: The peerforum search allows users to perform advanced searches for peerforum posts
  In order to perform an advanced search for a peerforum post
  As a teacher
  ...
  Background:
    ...
    And I add a new topic to "News peerforum" peerforum with:
      | Subject | My subject |
      | Message | My message |
    And I follow "Course 1"
    And I add a new topic to "News peerforum" peerforum with:
  ...
  Scenario: Perform an advanced search using any term
    ...
    And I follow "Course 1"
    And I follow "News peerforum"
    And I press "Search peerforums"
    And I should see "Advanced search"
    And I set the field "words" to "subject"
    When I press "Search peerforums"
