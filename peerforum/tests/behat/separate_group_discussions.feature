...
Feature: Posting to all groups in a separate group discussion is restricted to users with access to all groups
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peerforum | Standard peerforum name | Standard peerforum description | C1     | sepgroups | 1         |

  Scenario: Teacher with accessallgroups can view all groups
    Given I log in as "teacher1"
    And I follow "Course 1"
    When I follow "Standard peerforum name"
  ...
  Scenario: Students can view all participants discussions in separate groups mode
    Given I log in as "teacher1"
    And I follow "Course 1"
    When I add a new discussion to "Standard peerforum name" peerforum with:
      | Subject | PeerForum post to all participants |
    ...
    And I follow "Course 1"
    And I follow "Standard peerforum name"
    Then I should see "PeerForum post to all participants"
