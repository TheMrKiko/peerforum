...
Feature: Export peerforum
  In order to parse peerforum data for linguistic analysis
  As a teacher
  I need to export the peerforum data for select users

  Background: Add a peerforum and a discussion
    ...
    And the following "activities" exist:
      ...
      | peerforum | Test peerforum 1 | Test peerforum 1 description | general | C1     | 123      |

  Scenario: Teacher can export peerforum
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I follow "Test peerforum 1"
  ...
  Scenario: Students cannot export peerforum by default
  ...
  Scenario: User with the capability can export
    Given the following "permission overrides" exist:
      ...
      | mod/peerforum:exportpeerforum | Allow      | student | Course       | C1        |
