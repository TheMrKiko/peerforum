@mod @mod_peerforum @core_tag
Feature: Edited peerforum posts handle tags correctly
  In order to get peerforum posts properly labelled
  As a user
  ...
  @javascript
  Scenario: PeerForum post edition of custom tags works as expected
  ...
  @javascript
  Scenario: PeerForum post edition of standard tags works as expected
