@mod @mod_peerforum
Feature: PeerForum posts can be replied to in private
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peerforum | Study discussions | Test peerforum description | C1     | peerforum |
    ...
    And I am on "Science 101" course homepage
    And I reply "Answers to the homework" post from "Study discussions" peerforum with:
