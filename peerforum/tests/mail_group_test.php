 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_peerforum_mail_group_testcase extends advanced_testcase {
    ...
    /**
     * Ensure that posts written in a peerforum marked for separate groups includes notifications for the members of that
    ...
    /**
     * Ensure that posts written in a peerforum marked for visible groups includes notifications for the members of that
     * group, and any user with accessallgroups.
     */
