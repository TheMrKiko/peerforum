YUI.add('moodle-mod_peerforum-subscriptiontoggle', function (Y, NAME) {
...
// along with Moodle.  If not, see <http://www.gnu.org/licenses/>.
     ...
     * @main       moodle-mod_peerforum-subscriptiontoggle
     */

    /**
     * @namespace M.mod_peerforum
    ...
    var LOGNAME = 'moodle-mod_peerforum-subscriptiontoggle';
    ...
    Y.extend(SubscriptionToggle, Y.Base, {
        ...
        _toggleSubscription: function (e) {
            ...
            Y.io(this.get('uri'), {
                data: {
                    ...
                    peerforumid: clickedLink.getData('peerforumid'),
        ...
        ATTRS: {
             ...
             * @attribute uri
             * @type String
             * @default M.cfg.wwwroot + '/mod/peerforum/subscribe_ajax.php'
             */
            uri: {
                value: M.cfg.wwwroot + '/mod/peerforum/subscribe_ajax.php'
            }
        }
    });

    var NS = Y.namespace('M.mod_peerforum.subscriptiontoggle');
