...
/**
 * Module containing the selectors for the peerforum summary report.
 *
 * @module     peerforumreport_summary/selectors
...
export default {
    filters: {
        ...
        exportlink: {
            link: '#summaryreport #peerforumreport_summary_table button.export-link'
        }
    }
};
