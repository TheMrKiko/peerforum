...
Feature: Message users in the summary report
  ...
  Background:
    ...
    And the following peerforum replies exist in course "Course 1":
      | user     | peerforum  | discussion  | message     |
      | teacher1 | peerforum1 | discussion1 | t1 between  |
      | teacher1 | peerforum1 | discussion2 | t1 latest   |
      | student1 | peerforum1 | discussion1 | s1 earliest |
