...
Feature: Groups report filter is available if groups exist
  In order to retrieve targeted peerforum data
  As a teacher
  I can filter the peerforum summary report by groups of users
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peerforum | peerforum1 | C1 first peerforum  | C1     | peerforum1 | 1         |
      | peerforum | peerforum2 | C1 second peerforum | C1     | peerforum2 | 2         |
      | peerforum | peerforum1 | C2 first peerforum  | C2     | peerforum1 | 0         |
    And the following peerforum discussions exist in course "Course 1":
      | user     | peerforum  | name        | message    | group            | created           |
      | teacher1 | peerforum1 | discussion1 | D1 message | G1               | ## 1 month ago ## |
      | teacher1 | peerforum1 | discussion2 | D2 message | G2               | ## 1 week ago ##  |
      | teacher1 | peerforum2 | discussion3 | D3 message | G1               | ## 6 days ago ##  |
      | teacher1 | peerforum2 | discussion4 | D4 message | G4               | ## 5 days ago ##  |
      | teacher1 | peerforum2 | discussion5 | D5 message | All participants | ## 4 days ago ##  |
      | student1 | peerforum1 | discussion6 | D6 message | G3               | ## 3 days ago ##  |
      | student2 | peerforum2 | discussion7 | D7 message | All participants | ## 2 days ago ##  |
    And the following peerforum replies exist in course "Course 1":
      ...
      | teacher1 | peerforum2 | discussion3 | D3 reply   | ## 4 days ago ##  |
      | teacher1 | peerforum1 | discussion6 | D6 reply   | ## 2 days ago ##  |
      | student1 | peerforum1 | discussion6 | D6 reply 2 | ## 2 days ago ##  |
      | student2 | peerforum2 | discussion4 | D4 reply   | ## 4 days ago ##  |
      | student2 | peerforum2 | discussion5 | D5 reply   | ## 3 days ago ##  |
  ...
  Scenario: The summary report can be filtered by no groups only
    ...
    And I follow "peerforum2"
    And I navigate to "PeerForum summary report" in current page administration
    Then the following should exist in the "peerforumreport_summary_table" table:
    # |                      | Discussions | Replies |
      | First name / Surname | -3- | -4- |
      | Student 1            | 0   | 0   |
      | Student 2            | 1   | 2   |
  ...
  @javascript
  Scenario: Course peerforum summary report can be filtered by group
    When I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "peerforum2"
    And I navigate to "PeerForum summary report" in current page administration
    And I select "All peerforums in course" from the "PeerForum selected" singleselect
    And I click on "Groups" "button"
    And I click on "Clear" "button" in the "filter-groups-popover" "region"
    And I click on "Group A" "checkbox" in the "filter-groups-popover" "region"
    And I click on "Group C" "checkbox" in the "filter-groups-popover" "region"
