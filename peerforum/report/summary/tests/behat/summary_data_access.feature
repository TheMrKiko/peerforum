...
Feature: Report relevant content availability
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peerforum | peerforum1 | C1 peerforum | C1     | peerforum1 |
    And the following peerforum discussions exist in course "Course 1":
      ...
      | teacher1 | peerforum1 | discussion1 | message 1 |             |                   |
      | student1 | peerforum1 | discussion2 | message 3 | att1.jpg    | in1.jpg           |
      | student2 | peerforum1 | discussion3 | message 4 | att3.jpg    |                   |
    And the following peerforum replies exist in course "Course 1":
      ...
      | student1 | peerforum1 | discussion1 | reply1  | att4.jpg, att5.jpg | in2.jpg           |
      | student2 | peerforum1 | discussion2 | reply2  |                    |                   |
  ...
  Scenario: Students cannot access the summary report by default
    ...
    When I am on "Course 1" course homepage
    And I follow "peerforum1"
    Then "PeerForum summary report" "link" should not exist in current page administration
