...
class restore_peerforum_activity_task extends restore_activity_task {
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('peerforum', 'add discussion', 'discuss.php?d={peerforum_discussion}',
                '{peerforum_discussion}');
        $rules[] = new restore_log_rule('peerforum', 'view discussion', 'discuss.php?d={peerforum_discussion}',
                '{peerforum_discussion}');
        $rules[] = new restore_log_rule('peerforum', 'move discussion', 'discuss.php?d={peerforum_discussion}',
                '{peerforum_discussion}');
