...
switch ($peerforum->type) {
    ...
    case 'eachuser':
        ...
        if (!empty($showall)) {
            ...
            peerforum_print_latest_discussions($course, $peerforum, -1, 'header', '', -1, -1, $page,
                    $CFG->peerforum_manydiscussions, $cm);
        }
        break;
    ...
    case 'blog':
        echo '<br />';
        if (!empty($showall)) {
            peerforum_print_latest_discussions($course, $peerforum, 0, 'plain', 'p.created DESC', -1, -1, -1, 0, $cm);
        } else {
            peerforum_print_latest_discussions($course, $peerforum, -1, 'plain', 'p.created DESC', -1, -1, $page,
                    $CFG->peerforum_manydiscussions, $cm);
        }
        break;
