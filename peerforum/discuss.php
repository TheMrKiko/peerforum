...
$node = $peerforumnode->add(format_string($discussion->name),
...
peerforum_print_discussion($course, $cm, $peerforum, $discussion, $post, $displaymode, $canreply, $canratepeer, $cangrade, false,
        true, null, null);
