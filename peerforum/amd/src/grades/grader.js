 ...
 *
 * @module     mod_peerforum/grades/grader
...
const templateNames = {
    contentRegion: 'mod_peerforum/grades/grader/discussion/posts',
};
...
export const registerLaunchListeners = () => {
    document.addEventListener('click', async(e) => {
        if (e.target.matches(Selectors.launch)) {
            ...
            if (rootNode.matches(Selectors.gradableItems.wholePeerForum)) {
                ...
                e.preventDefault();
                try {
                    await launchWholePeerForumGrading(rootNode, {
