 ...
 *
 * @module     mod_peerforum/grades/expandconversation
 * @package    mod_peerforum
 * @copyright  2019 Mathew May <mathew.solutions>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
import * as PeerForumSelectors from './grader/selectors';
import Repository from 'mod_peerforum/repository';
 ...
 * @returns {HTMLElement}
 */
const findGradableNode = node => node.closest(PeerForumSelectors.expandConversation);
...
const showPostInContext = async(rootNode, {
    ...
    const templatePromise = Templates.render('mod_peerforum/grades/grader/discussion/post_modal', {
        posts,
