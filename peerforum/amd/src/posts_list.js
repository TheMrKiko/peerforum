 ...
 *
 * @module     mod_peerforum/posts_list
...
define([
    ...
    var registerEventListeners = function (root) {
        root.on('click', Selectors.post.inpageReplyLink, function (e) {
            ...
            var currentTarget = $(e.currentTarget).parents(Selectors.post.peerforumCoreContent);
            var currentSubject = currentTarget.find(Selectors.post.peerforumSubject);
