 ...
 *
 * @module     mod_peerforum/local/grades/local/grader/user_picker
...
const templatePath = 'mod_peerforum/local/grades/local/grader';
...
class UserPicker {
    ...
    async showUser(user) {
        ...
        currentUserRegion.textContent = await getString('nowgradinguser', 'mod_peerforum', user.fullname);
    }
