...
/**
 * This module handles the in page replying to peerforum posts.
 *
 * @module     mod_peerforum/inpage_reply
...
define([
    ...
    var EVENTS = {
        POST_CREATED: 'mod_peerforum-post-created'
    };
                    ...
                    .then(function (context) {
                        ...
                        switch (mode) {
                            case DISPLAYCONSTANTS.NESTED_V2:
                                ...
                                return Templates.render('mod_peerforum/peerforum_discussion_nested_v2_post_reply', post);
                            case DISPLAYCONSTANTS.THREADED:
                                return Templates.render('mod_peerforum/peerforum_discussion_threaded_post', post);
                            case DISPLAYCONSTANTS.NESTED:
                                return Templates.render('mod_peerforum/peerforum_discussion_nested_post', post);
                            default:
