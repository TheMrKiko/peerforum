...
echo json_encode(array('$time_assigned' => $time_assigned, 'result' => $result, 'peerid' => $peerid, 'itemid' => $itemid,
        'peersnames' => $peersnames, 'courseid' => $courseid, 'canassign' => $students_html, 'canremove' => $students_rmv_html,
        'show' => $show_assignparent));
