 ...
 */
class peerforum_post implements \renderable, \templatable {
     ...
     * @return array Data ready for use in a mustache template
     */
    protected function export_for_template_text(\mod_peerforum_renderer $renderer) {
        ...
        return $data + array(
                        ...
                        'peerforumname' => html_entity_decode($this->get_peerforumname()),
     ...
     * @return array Data ready for use in a mustache template
     */
    protected function export_for_template_html(\mod_peerforum_renderer $renderer) {
        $data = $this->export_for_template_shared($renderer);
        return $data + array(
                        'id' => $this->post->id,
    ...
    /**
     * ID number of the course that the peerforum is in.
     *
     * @return string
     */
    ...
    /**
     * The full name of the course that the peerforum is in.
     *
     * @return string
     */
