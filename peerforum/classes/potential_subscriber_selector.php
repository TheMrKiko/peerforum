 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_peerforum_potential_subscriber_selector extends mod_peerforum_subscriber_selector_base {
    /**
    ...
    public function find_users($search) {
        ...
        $cm = get_coursemodule_from_instance('peerforum', $this->peerforumid);
