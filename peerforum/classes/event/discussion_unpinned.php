...
/**
 * The mod_peerforum discussion unpinned event.
 *
...
class discussion_unpinned extends \core\event\base {
    ...
    public function get_description() {
        return "The user {$this->userid} has unpinned the discussion {$this->objectid} in the peerforum {$this->other['peerforumid']}";
    }
    ...
    public static function get_name() {
        return get_string('eventdiscussionunpinned', 'mod_peerforum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'peerforum', 'unpin discussion', $logurl, $this->objectid, $this->contextinstanceid);
    }
