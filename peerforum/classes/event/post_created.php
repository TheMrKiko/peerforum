...
/**
 * The mod_peerforum post created event.
 *
...
/**
 * The mod_peerforum post created event class.
 *
...
class post_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostcreated', 'mod_peerforum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'peerforum', 'add post', $logurl, $this->other['peerforumid'], $this->contextinstanceid);
    }
