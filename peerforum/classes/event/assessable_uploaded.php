...
/**
 * The mod_peerforum assessable uploaded event.
 *
...
/**
 * The mod_peerforum assessable uploaded event class.
 *
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has posted content in the peerforum post with id '$this->objectid' " .
                "in the discussion '{$this->other['discussionid']}' located in the peerforum with course module id " .
    ...
    protected function get_legacy_eventdata() {
        ...
        $eventdata->modulename = 'peerforum';
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'mod_peerforum');
    }
