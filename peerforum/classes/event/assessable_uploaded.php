...
/**
 * mod_peerforum assessable uploaded event.
 *
...
/**
 * mod_peerforum assessable uploaded event class.
 *
 * @package    mod_peerforum
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "User {$this->userid} has posted some content in the peerforum post {$this->objectid}.";
    }
    ...
    public static function get_name() {
        return get_string('event_assessable_uploaded', 'mod_peerforum');
    }
