...
class discussion {
    ...
    private $courseid;
    /** @var int $peerforumid PeerForum id */
    private $peerforumid;
     ...
     * @param int $peerforumid PeerForum id
     ...
     * @return int
     */
    public function get_peerforum_id(): int {
        return $this->peerforumid;
    }
    ...
    public function is_timed_discussion(): bool {
        ...
        return !empty($CFG->peerforum_enabletimedposts) &&
