...
class posts {
    ...
    /**
     * Render the given posts for the peerforums and discussions.
     *
     * @param stdClass $user The user viewing the posts
     * @param peerforum_entity[] $peerforums A list of all peerforums for these posts
    ...
    public function render(
        ...
        if ($this->postprocessfortemplate !== null) {
            ...
            $exportedposts = ($this->postprocessfortemplate)($exportedposts, $peerforums, $discussions, $user);
        }
