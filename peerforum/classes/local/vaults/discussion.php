...
class discussion extends db_table_vault {
    ...
    /**
     * Get all discussions in the specified peerforum.
     *
     * @param peerforum_entity $peerforum
     * @return  array
     */
    public function get_all_discussions_in_peerforum(peerforum_entity $peerforum, string $sort = null): ?array {
    ...
    /**
     * Get the first discussion in the specified peerforum.
     *
     * @param peerforum_entity $peerforum
     * @return  discussion_entity|null
     */
    public function get_first_discussion_in_peerforum(peerforum_entity $peerforum): ?discussion_entity {
        $records = $this->get_db()->get_records(self::TABLE, [
                'peerforum' => $peerforum->get_id(),
    ...
    /**
     * Get the last discussion in the specified peerforum.
     *
     * @param peerforum_entity $peerforum
     * @return  discussion_entity|null
     */
    public function get_last_discussion_in_peerforum(peerforum_entity $peerforum): ?discussion_entity {
        $records = $this->get_db()->get_records(self::TABLE, [
                'peerforum' => $peerforum->get_id(),
    ...
    /**
     * Get the count of the discussions in the specified peerforum.
     *
     * @param peerforum_entity $peerforum
     * @return  int
     */
    public function get_count_discussions_in_peerforum(peerforum_entity $peerforum): ?int {
    ...
    public function update_discussion(discussion_entity $discussion): ?discussion_entity {
        ...
        if ($this->get_db()->update_record('peerforum_discussions', $discussionrecord)) {
