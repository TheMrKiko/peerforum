...
use mod_peerforum\local\exporters\group as group_exporter;
        ...
        if ($this->canview) {
            if ($author->is_deleted()) {
                return [
                        ...
                        'groups' => [],
                        'urls' => [
                                'profile' => ($urlfactory->get_author_profile_url($author,
                                        $peerforum->get_course_id()))->out(false),
            ...
            return [
                    'id' => null,
                    'fullname' => get_string('peerforumauthorhidden', 'mod_peerforum'),
                    'isdeleted' => null,
                    'groups' => [],
                    'urls' => [
                            'profile' => null,
