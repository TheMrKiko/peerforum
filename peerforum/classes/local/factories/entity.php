...
use mod_peerforum\local\entities\discussion_summary as discussion_summary_entity;
...
/**
 * Entity factory to create the peerforum entities.
 *
 * See:
...
class entity {
    /**
     * Create a peerforum entity from a stdClass (legacy peerforum object).
     *
     * @param stdClass $record The peerforum record
     * @param context $context The peerforum module context
     * @param stdClass $coursemodule Course module record for the peerforum
     * @param stdClass $course Course the peerforum belongs to
     * @return peerforum_entity
     */
    public function get_peerforum_from_stdclass(
            stdClass $record,
            context $context,
        ...
        return new peerforum_entity(
                ...
                $record->scale,
                $record->grade_peerforum,
                $record->grade_peerforum_notify,
                $record->maxbytes,
                ...
                $record->minpeergraders,
                $record->finishpeergrade,
                $record->timetopeergrade,
                ...
                $record->peergradecriteria,
                $record->gradecriteria1,
                $record->gradecriteria2,
                $record->gradecriteria3,
                $record->showpostid,
                $record->showdetails,
                $record->autoassignreplies,
                $record->hidereplies,
                $record->peernominations,
                $record->peerrankings,
