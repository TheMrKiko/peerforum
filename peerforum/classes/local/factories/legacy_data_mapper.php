...
use mod_peerforum\local\data_mappers\legacy\author as author_data_mapper;
use mod_peerforum\local\data_mappers\legacy\discussion as discussion_data_mapper;
use mod_peerforum\local\data_mappers\legacy\peerforum as peerforum_data_mapper;
use mod_peerforum\local\data_mappers\legacy\post as post_data_mapper;
...
class legacy_data_mapper {
    /**
     * Create a legacy peerforum data mapper.
     *
     * @return peerforum_data_mapper
     */
    public function get_peerforum_data_mapper(): peerforum_data_mapper {
        return new peerforum_data_mapper();
    }
     ...
     *
     * @param string $entity
     * @return author_data_mapper|discussion_data_mapper|peerforum_data_mapper|post_data_mapper
     */
    public function get_legacy_data_mapper_for_vault($entity) {
        switch ($entity) {
            case 'peerforum':
                return $this->get_peerforum_data_mapper();
            case 'discussion':
