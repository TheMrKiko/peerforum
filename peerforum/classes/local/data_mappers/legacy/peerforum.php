    ...
    public function to_legacy_objects(array $peerforums): array {
        return array_map(function(peerforum_entity $peerforum) {
            return (object) [
                    ...
                    'peergradescale' => $peerforum->get_peergradescale(),
                    'peergradeassessed' => $peerforum->get_peergrade_aggregate(),
                    'peergradeassesstimestart' => $peerforum->get_peergradeassesstimestart(),
                    'peergradeassesstimefinish' => $peerforum->get_peergradeassesstimefinish(),
                    'peergradesvisibility' => $peerforum->get_peergradesvisibility(),
                    'whenpeergrades' => $peerforum->get_whenpeergrades(),
                    'feedbackvisibility' => $peerforum->get_feedbackvisibility(),
                    'whenfeedback' => $peerforum->get_whenfeedback(),
                    'enablefeedback' => $peerforum->is_enablefeedback(),
                    'remainanonymous' => $peerforum->is_remainanonymous(),
                    'selectpeergraders' => $peerforum->get_selectpeergraders(),
                    ...
                    'expirepeergrade' => $peerforum->is_expirepeergrade(),
                    'gradeprofessorpost' => $peerforum->is_gradeprofessorpost(),
                    'showpeergrades' => $peerforum->is_showpeergrades(),
                    'outdetectvalue' => $peerforum->get_outdetectvalue(),
                    'blockoutliers' => $peerforum->is_blockoutliers(),
                    'seeoutliers' => $peerforum->is_seeoutliers(),
                    'outlierdetection' => $peerforum->get_outlierdetection(),
                    'warningoutliers' => $peerforum->get_warningoutliers(),
                    'showafterrating' => $peerforum->is_showafterrating(),
                    'showratings' => $peerforum->is_showratings(),
                    'showafterpeergrade' => $peerforum->is_showafterpeergrade(),
                    'peergradecriteria' => $peerforum->get_peergradecriteria(),
                    'gradecriteria1' => $peerforum->get_gradecriteria_1(),
                    'gradecriteria2' => $peerforum->get_gradecriteria_2(),
                    'gradecriteria3' => $peerforum->get_gradecriteria_3(),
                    'showpostid' => $peerforum->is_showpostid(),
                    'showdetails' => $peerforum->is_showdetails(),
                    'autoassignreplies' => $peerforum->is_autoassignreplies(),
                    'hidereplies' => $peerforum->is_hidereplies(),
                    'peernominations' => $peerforum->is_peernominations(),
                    'peerrankings' => $peerforum->is_peerrankings(),
                    'peernominationsfields' => $peerforum->get_peernominationsfields(),
                    'peernominationsaddfields' => $peerforum->is_peernominationsaddfields(),
                    'random_distribution' => $peerforum->is_random_distribution(),
                    'training' => $peerforum->is_training(),
                    'threaded_grading' => $peerforum->is_threaded_grading(),
                    'adv_peergrading' => $peerforum->is_adv_peergrading(),
            ];
        }, $peerforums);
    }
