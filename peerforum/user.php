...
foreach ($result->posts as $post) {
    ...
    if ($peerforum->type != 'single') {
        ...
        if ($post->parent != 0) {
            ...
            if (!$isspecificcourse && !$hasparentaccess) {
                $fullsubjects[] .= html_writer::link(new moodle_url('/mod/peerforum/discuss.php',
    ...
    $postoutput[] =
            peerforum_print_post($post, $discussion, $peerforum, $cm, $course, false, false, false, $fulllink, '', null, true, null,
                    true);
}
