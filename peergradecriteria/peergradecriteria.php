...
if ($feedback != PEERGRADE_UNSET_FEEDBACK) {
    ...
    if (isset($grade1)) {
        if ($grade1 != PEERGRADE_UNSET_PEERGRADE) {
            $exists_peergrade = $DB->get_record('peerforum_peergradecriteria',
                    array('userid' => $USER->id, 'itemid' => $itemid, 'criteria' => $criteria1));
    ...
    if (isset($grade2)) {
        if ($grade2 != PEERGRADE_UNSET_PEERGRADE) {
            $exists_peergrade = $DB->get_record('peerforum_peergradecriteria',
                    array('userid' => $USER->id, 'itemid' => $itemid, 'criteria' => $criteria2));
    ...
    if (isset($grade3)) {
        if ($grade3 != PEERGRADE_UNSET_PEERGRADE) {
            $exists_peergrade = $DB->get_record('peerforum_peergradecriteria',
                    array('userid' => $USER->id, 'itemid' => $itemid, 'criteria' => $criteria3));
