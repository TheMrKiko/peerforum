...
class restore_forum_activity_task extends restore_activity_task {
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] =
                new restore_log_rule('forum', 'add post', 'discuss.php?d={forum_discussion}&parent={forum_post}', '{forum_post}');
        $rules[] =
                new restore_log_rule('forum', 'update post', 'discuss.php?d={forum_discussion}#p{forum_post}&parent={forum_post}',
                        '{forum_post}');
        $rules[] = new restore_log_rule('forum', 'update post', 'discuss.php?d={forum_discussion}&parent={forum_post}',
                '{forum_post}');
