...
class mod_forum_mail_testcase extends advanced_testcase {
    ...
    public function test_long_subject() {
        ...
        // Post a discussion to the forum.
        $subject =
                'This is the very long forum post subject that somebody was very kind of leaving, it is intended to check if long subject comes in mail correctly. Thank you.';
