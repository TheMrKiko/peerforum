...
class mod_forum_subscriptions_testcase extends advanced_testcase {
    ...
    public function test_get_user_default_subscription() {
        ...
        // A guest user.
        $this->setUser(0);
        $this->assertFalse((boolean) \mod_forum\subscriptions::get_user_default_subscription($forum, $context, $cm,
                $discussion->id));
        ...
        $this->assertTrue((boolean) \mod_forum\subscriptions::get_user_default_subscription($forum, $context, $cm,
                $discussion->id));
