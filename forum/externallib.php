        ...
        if (!empty($params['courseids'])) {
            ...
            foreach ($forums as $forum) {
                ...
                list($forum->intro, $forum->introformat) =
                        external_format_text($forum->intro, $forum->introformat, $context->id, 'mod_forum', 'intro', null,
                                $options);
        ...
        return new external_multiple_structure(
                new external_single_structure(
                        array(
                                ...
                                'grade_forum_notify' => new external_value(PARAM_INT,
                                ...
                                'numdiscussions' => new external_value(PARAM_INT, 'Number of discussions in the forum',
                                        VALUE_OPTIONAL),
