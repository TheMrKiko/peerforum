...
class core_rating_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function test_get_item_ratings() {
        ...
        $ratings =
                core_rating_external::get_item_ratings('module', $this->forum->cmid, 'mod_forum', 'post', $this->post->id, 100, '');
        ...
        try {
            $ratings =
                    core_rating_external::get_item_ratings('module', $this->forum->cmid, 'mod_forum', 'xyz', $this->post->id, 100,
                            '');
